    ...
    public partial class Form2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (comboBox1.SelectedIndex == 0)
            {
                ...
                {
                    DBCON.sqlToDbWithChanges($"INSERT INTO public.product(title, producttypeid, articlenumber, description, image, productionpersoncount, productionworkshopnumber, mincostforagent) VALUES ('{textBox2.Text}', {textBox3.Text}, '{textBox4.Text}', '{textBox5.Text}', '{textBox6.Text}', {textBox7.Text}, {textBox8.Text}, {textBox9.Text});");
                    this.Close();
                }
            }
            if (comboBox1.SelectedIndex == 1)
            {
                ...
                {
                    DBCON.sqlToDbWithChanges($"UPDATE public.product SET title='{textBox2.Text}', producttypeid={textBox3.Text}, articlenumber='{textBox4.Text}', description='{textBox5.Text}', image='{textBox6.Text}', productionpersoncount={textBox7.Text}, productionworkshopnumber={textBox8.Text}, mincostforagent={textBox9.Text} WHERE id = {textBox1.Text};");
                    this.Close();
                }
            ...
            if (comboBox1.SelectedIndex == 2)
            {
                ...
                {
                    DBCON.sqlToDbWithChanges($"DELETE FROM public.product WHERE id = {textBox1.Text};");
                    this.Close();
                }
            }
        }
